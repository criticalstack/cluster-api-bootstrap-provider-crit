...
func NewCertificatesForControlPlane(certificatesDir string) Certificates {
	return Certificates{
		&Certificate{
			Purpose:  ClusterCA,
		...
		&Certificate{
			Purpose:  AuthProxyCA,
			CertFile: filepath.Join(certificatesDir, "auth-proxy-ca.crt"),
			KeyFile:  filepath.Join(certificatesDir, "auth-proxy-ca.key"),
		},
		&Certificate{
			Purpose:  EtcdCA,
...
func NewCertificatesForWorker(certificatesDir string) Certificates {
	return Certificates{
		&Certificate{
			Purpose:  ClusterCA,
			CertFile: filepath.Join(certificatesDir, "ca.crt"),
