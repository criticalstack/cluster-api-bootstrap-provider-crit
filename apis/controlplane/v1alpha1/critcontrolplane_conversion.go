...
func (src *CritControlPlane) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*v1alpha2.CritControlPlane)

	if err := Convert_v1alpha1_CritControlPlane_To_v1alpha2_CritControlPlane(src, dst, nil); err != nil {
		return err
	}
...
func (dst *CritControlPlane) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1alpha2.CritControlPlane)

	if err := Convert_v1alpha2_CritControlPlane_To_v1alpha1_CritControlPlane(src, dst, nil); err != nil {
		return err
	}
	return nil
}
